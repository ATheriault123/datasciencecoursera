...
png('C:/Users/AMThe/OneDrive/Documents/datasciencecoursera/plot1.png', width=480, height=480)

hist(sub$Global_act_power, col='red', xlab='Global Active Power (kilowatts)', main='Global Active Power', ylim=c(0,1200))
